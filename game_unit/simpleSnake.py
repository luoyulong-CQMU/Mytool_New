...
class mySnake(object):
    ...
    def init_snake(self):
        snake = deque()
        snake.append((2, self.SCOPE_Y[0]))
        snake.append((1, self.SCOPE_Y[0]))
        snake.append((0, self.SCOPE_Y[0]))
        return snake
    ...
    def main(self,father_window):
        ...
        while True:
            ...
            # 画蛇
            for s in snake:
                pygame.draw.rect(screen, self.DARK, (s[0] * self.SIZE + self.LINE_WIDTH, s[1] * self.SIZE + self.LINE_WIDTH,
