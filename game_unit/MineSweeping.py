...
from game_unit.mineblock import *

class Sweeping(object):
    def __init__(self):
        # 游戏屏幕的宽
        self.SCREEN_WIDTH = BLOCK_WIDTH * SIZE
        # 游戏屏幕的高
        self.SCREEN_HEIGHT = (BLOCK_HEIGHT + 2) * SIZE
    ...
    def main(self,father_window=None):
        ...
        face_pos_x = (self.SCREEN_WIDTH - face_size) // 2
        ...
        while True:
            ...
            self.print_text(screen, font1, 30, (SIZE * 2 - fheight) // 2 - 2, '%02d' % (MINE_COUNT - flag_count), red)
            if game_status == GameStatus.started:
                elapsed_time = int(time.time() - start_time)
            self.print_text(screen, font1, self.SCREEN_WIDTH - fwidth - 30, (SIZE * 2 - fheight) // 2 - 2, '%03d' % elapsed_time, red)
